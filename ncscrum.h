...
# endif /* BBL */
     ...
     &                         indxHS=indxAi+4, indxTIsrf=indxAi+5)
      ...
      integer indxRUNOFF
      parameter (indxRUNOFF=indxSST+9)
      integer indxTRIVER
      parameter (indxTRIVER=indxSST+10)
      integer indxSRIVER
      parameter (indxSRIVER=indxSST+11)
...
#if defined PSOURCE
      character*80  riverfile
      character*15  nameriver(Msrc)
      common /source_nameriver/ nameriver
#endif
